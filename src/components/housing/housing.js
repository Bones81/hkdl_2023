...
const Housing = () => {
    return (
        <section id='housing'>
            <h2>Housing</h2>
            <h3 className='special-note'>This section needs updating for 2022.</h3>
            ...
            <h3>Unknown hotel, our quarantine home</h3>
                <p>This is, of course, a brand new wrinkle to the contract. Won't be able to leave the room for any reason for 14 days, with the possibility that quarantine could be lifted early.</p>
                <p>A key moment will be when we first arrive into this "quarantine home." Almost immediately upon arrival, we will have to activate our StayHomeSafe app, which will give us one minute--or possibly even less--to walk the perimeter of our hotel room so that the GPS knows where we will be for the next 14 days. Yikes! Make sure you cover the entire perimeter of your room quickly without running (Apparently the GPS doesn't work right if you run because it measures data every few steps.), or else you'll have to contact someone to help you reset your perimeter.</p>
                <p>It is still not entirely clear how the food situation will be handled, except that all meals will be delivered to your room. A lot may depend on the hotel Disney selects. Breakfast may be provided by the hotel. But it sounds like we will be responsible for paying for the majority of our food via our weekly 'per diem.' I would imagine the cost will just go onto our hotel bill, which Disney will pay when we complete the quarantine period, and then perhaps they deduct the food amount from our paycheck. The payment end of things has not been made clear to us yet.</p>
                ...
                <p>My understanding is also that we will have to take another COVID test on the 10th day of quarantine.</p>
                <p>If you make a mess (spill fish soup or stain the rug with tea, for example) you'll likely have to request cleaning supplies from the front desk.</p>
                <p>If you need to do laundry, you will probably have to do it by hand in your bathtub, or else it's not happening. Consider bringing some soap or laundry detergent pods.</p>
            ...
            <h3 id="HPRC"><a href="https://www.harbour-plaza.com/resortcity/Index-en.htm">Harbour Plaza Resort City, or HPRC</a></h3>
                ...
                <p>Located in the Tin Shui Wai neighborhood, very close to the border with mainlaind China and the 12.5 million-person city Shenzhen, <a target="_blank" href="https://www.harbour-plaza.com/resortcity/Index-en.htm">HPRC</a> is our home in HK. All of HKDL's expats are housed there.</p>
