    ...
    return (
        <section id='housing'>
            ...
            <h3>Unknown hotel, our quarantine home</h3>
                ...
                <p>It is still not entirely clear how the food situation will be handled, except that all meals will be delivered to your room. A lot may depend on the hotel Disney selects. Breakfast may be provided by the hotel. When we quarantined in 2020, 3 meals were delivered each day, but we had the option to order delivery on our own dime from a variety of restaurants via FoodPanda (which is like GrubHub).</p>
