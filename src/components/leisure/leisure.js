        ...
        <section id='leisure'>
            ...
            <h3>The big tourist stuff</h3>
                <ul className='leisure-ul'>
                    ...
                    <img className="list-pic" src="./assets/Big Buddha.jpg" alt='big buddha'/>
                    <p className="img-caption">The Tian Tan (aka "Big") Buddha</p>
                    <li>Victoria Peak/Peak Tram</li>
                    <img className="list-pic" src="./assets/Victoria Peak Lookout Daytime.jpg" alt='victoria peak lookout'/>
                    ...
                    <img className="list-pic" src="./assets/Symphony of Lights.jpg" alt='symphony of lights'/>
                    ...
                    <img className="list-pic" src="./assets/chilinnunnery.jpg" alt='chi lin nunnery'/>
                    <p className="img-caption">The Chi Lin Nunnery</p>
                    <li>Wong Tai Sin Sik Sik Yuen Temple</li>
                    <img className="list-pic" src="./assets/Wong Tai Sin Temple.jpg" alt='wong tai sin temple'/>
                    <p className="img-caption">Wong Tai Sin Sik Sik Yuen temple</p>
                    <li>TST Promenade/Bruce Lee Statue</li>
                    <img className="list-pic" src="./assets/Bruce Lee poser.jpg" alt='bruce lee statue and poser'/>
                    <p className="img-caption">Bruce Lee Statue on the TST promenade</p>
                    <li>HSBC Building</li>
                    <li>High Tea at The Peninsula</li>
                    <img className="list-pic" src="./assets/Peninsula High Tea.jpg" alt='high tea at The Peninsula'/>
            ...
            <h3>Hiking</h3>
                ...
                <ul className='leisure-ul'>
                    <li>Dragon's Back</li>
                    <img className="hiking-pic" src="./assets/Dragon's Back view.jpg" alt="Dragon\'s Back"/>
                    <p className="img-caption">One of the views from Dragon's Back</p>
                    <li>Lantau Peak</li>
                    <img className="hiking-pic" src="./assets/Lantau Peak trail.jpg" alt='lantau peak trail'/>
                    <p className="img-caption">The Lantau Peak trail</p>
                    <li>Victoria Peak</li>
                    <img className="hiking-pic" src="./assets/Victoria Peak walk view.jpg" alt='Victoria Peak view'/>
                    <p className="img-caption">The view from atop Victoria Peak</p>
                    <li>Lion Rock</li>
                    <img id="sunset-peak-view" src="./assets/Lion Rock View.jpg" alt='Lion Rock view'/>
                    <p className="img-caption">The view from Lion Rock</p>
                    <li>Tai Tong - Sweet Gum Woods</li>
                    <img className="hiking-pic" src="./assets/Tai Tong Ancient Heritage Trail.jpg" alt='tai tong trail'/>
                    <p className="img-caption">Part of the Ancient Heritage Trail on the Tai Tong hike</p>
                    <li>Sunset Peak</li>
                    <img className="hiking-pic" src="./assets/Hiking panorama.jpg" alt='hiking panorama'/>
