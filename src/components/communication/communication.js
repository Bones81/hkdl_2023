    ...
    return (
        <section id='communication'>
            ...
            <h3>VPNs - do you need one?</h3>
                <p>For the most part, our wifi and internet access has been fairly solid in HK, both at our hotel and at Disney. That said, mainland China continues to exert its influence (and attempts to censor) in HK, and it is potentially a very useful investment to have a VPN on your device(s).</p>
