const Flying = () => {
    return (
      <section id="flights">
        ...
        <h3>Flight info</h3>
        <p>HKDL has historically waited until the last week -- and sometimes even the last 72 hours -- to give us our flight information. It may feel a bit nerve-wracking to be inching closer to the flight date without any itinerary, but just know the flight info will show up!</p>
        ...
        <ul>
            ...
            <li>Group 2 (Sarah, Chelsea, Omar, Johnny): Flight date Nov 4 or 5, contract start Nov 6.</li>
        </ul>
        ...
        <p>
          You may be able to change your seat to one you prefer. May as well be as comfortable as possible for the
          long flight(s)! Use the "Airline Booking Ref" from your flight email
          (as seen in the pic below) to search for your itinerary.
        </p>
        <img className="list-pic" src="assets/flight_itinerary.jpg" />
        <h3>Baggage</h3>
        <p>
          Depending on what airline you are on, you usually get two complimentary checked bags up to 50lbs, as well as 1 bag
          + 1 personal item to carry on (total carry-on weight 22lbs). The
          fees are often hefty for exceeding the weight limits.
        </p>
        <p>
        ...
        <p>Be sure to check with your airline to arrange any special meals you may need/want.</p>
        ...
        <p> If you wish to have a high-quality mask for your flight, in 2020, bass Joshua recommended {" "}
