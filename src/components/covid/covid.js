...
const Covid = () => {
    return (
        <section>
            <h2 id="covid-clearance">COVID-related flying info and Cheat Sheet for COVID clearance</h2>
            <h3 className='special-note'>This section needs additional updates for 2022. The protocols are similar but not exactly the same.</h3>
                    ...
                    <ul className='covid-ol'>
                        ...
                        <li>in Nashville area:</li>
                            <ol className='covid-ol'>
                                ...
                                <li>Traveling to Atlanta and <a href="www.buckheadmedicine.com" target="_blank">Buckhead Medicine</a> may be a painful but necessary alternative if no places in Nashville can deliver what we need.</li>
                            </ol>
                    </ul>
            ...
            <h3>Arrival in HK, COVID testing/protocol</h3>
                ...
                <p>Other comments/recommendations for the waiting hall in HK: bring 1-2 fully charged power banks for your phone, as the availability of electrical outlets is limited. WiFi is "okay." You may receive a very minimal snack of white bread and lunch meat, but other than that, you'll need your own food.</p>
        </section>
    )
}
