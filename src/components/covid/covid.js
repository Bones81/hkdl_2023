    ...
    return (
        <section id="covid-clearance">
            ...
            <h3 className='special-note'>Most recent update: 9/14/22. Double-check official COVID-clearance resources for the most accurate and up-to-date info.</h3>
                ...
                <h4>Facilities to consider, based mostly on recommendations from people who have either successfully traveled to HK or understand the requirements well. There should be many more options in 2022 now that ISO lab certification is no longer required. Any PCR that returns the required information (as noted above) within 48 hours should work, even from a drug store like a Walgreens or CVS:</h4>
