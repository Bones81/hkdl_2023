...
const Covid = () => {
    return (
        <section id="covid-clearance">
            ...
            <h3 className='special-note'>This section is only partially updated for 2022. For the time being, much of this section is copy/pasted from 2020. Double-check official COVID-clearance resources for the most accurate and up-to-date info.</h3>
                ...
                <h3>The original HK govt document about COVID clearance is <a target="_blank" rel='noreferrer' href="https://www.coronavirus.gov.hk/eng/high-risk-places.html">here</a>. My cheat sheet version of this info is what follows below.</h3>
                <p>Short version - You need a qualifying test report, a qualifying lab certificate, and a quarantine hotel confirmation (which Disney will provide).</p>
                ...
                <ol className='covid-ol'>
                    ...
                    <li><strong>Confirmation of a hotel reservation</strong> in HK for the quarantine period. <strong>Disney has said they will provide this info to us</strong> once our flights and hotels are booked.</li>
                </ol>
                    ...
                    <ul className='covid-ol'>
                        ...
                        <li>in Dallas area:</li>
                            <ol className='covid-ol'>
                                ...
                                <li>After some research, we determined that <a target="_blank" rel='noreferrer' href="https://icare-er.com/">iCare ER & Urgent Care</a> (in Frisco or South Ft. Worth) should be able to satisfy your testing and reporting needs. A lab with the same address and the name "ICARE EMERGENCY CENTERS" has the CLIA number #45D2101753, which we found after searching <a target="_blank" rel='noreferrer' href="https://www.cms.gov/Regulations-and-Guidance/Legislation/CLIA/CLIA_Laboratory_Demographic_Information">this link to search labs that have CLIA certification</a>. </li>
                            </ol>
                        <li>in NYC area:</li>    
                            <ol className='covid-ol'>
                                <li><a target="_blank" rel='noreferrer' href="https://nyulangone.org/locations/virtual-urgent-care">NYU Langone</a>, must schedule virtual urgent care appt to get a COVID test appt. Here is a copy of <a target="_blank" rel='noreferrer' href="https://med.nyu.edu/pathology/sites/default/files/pathology/NYS-DOH-Clinical-Laboratory-Permit-June-30-21.pdf">their lab certification</a>. Many successful travelers to HK used NYU Langone.</li>
                            </ol>
                        <li>in Nashville area:</li>
                            <ol className='covid-ol'>
                                ...
                                <li>Traveling to Atlanta and <a href="http://www.buckheadmedicine.com" target="_blank" rel='noreferrer'>Buckhead Medicine</a> may be a painful but necessary alternative if no places in Nashville can deliver what we need.</li>
                            </ol>
                    </ul>
                <h4 class="special-note">And, same information one last time: A cheat sheet for what you must have before you can get on the plane (See <a href="#covid-clearance">above</a> for fuller descriptions of each item):
                    <ol className='covid-ol'>
                        ...
                        <li><strong>Proof of a quarantine hotel reservation</strong> in HK. Disney will provide this to us.</li>
                        
                    </ol>
                </h4>
            <h3>Arrival in HK, COVID testing/protocol</h3>
                <h4 class="special-note">I <em><strong>highly recommend</strong></em> printing and reading <a target="_blank" rel='noreferrer' href="./assets/Hong Kong Airport COVID Arrival Instructions (Aug 2020).pdf">this 3-page pdf file explaining in great detail the HK COVID-19 Travel Procedures</a>. It is filled with both instructions and useful recommendations for staying comfortable during the arrival testing process and waiting period. Here is <a target="_blank" rel='noreferrer' href="././assets/Pre Arrival and Arrival Instructions for Hong Kong as of 15 June 2020.pdf">another, smaller pdf file</a> (written up by a concerned mother of a teenaged traveler) noting the essential elements of the process.</h4>
