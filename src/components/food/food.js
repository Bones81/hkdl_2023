    ...
    return (
        <section id="food">
            ...
            <h3>Disney employee canteen/cafeteria</h3>
                ...
                <img id="fish-breakfast" src="Assets/Fish Breakfast.jpg" />
            ...
            <h3>Street Food</h3>
                ...
                <img class="list-pic" src="Assets/Dim Sum.jpg" />
                ...
                <img class="list-pic" src="Assets/Chinese Menu Weird Items.jpg" />
